...
type FeedResponse struct {
	...
	FeedData []*Post `protobuf:"bytes,1,rep,name=feedData,proto3" json:"feedData,omitempty"`
}
...
func (x *FeedResponse) GetFeedData() []*Post {
	if x != nil {
		return x.FeedData
	}
	return nil
...
var file_feed_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x8c, 0x01,
	0x0a, 0x04, 0x50, 0x6f, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x70, 0x6f, 0x73, 0x74, 0x69, 0x64, 0x12, 0x14,
	...
	0x09, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x36, 0x0a, 0x0c,
	0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x26, 0x0a, 0x08,
	0x66, 0x65, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a,
	0x2e, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x08, 0x66, 0x65, 0x65, 0x64,
	0x44, 0x61, 0x74, 0x61, 0x32, 0x41, 0x0a, 0x0b, 0x46, 0x65, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76,
...
var file_feed_proto_goTypes = []interface{}{
	...
	(*FeedResponse)(nil), // 2: feed.FeedResponse
}
var file_feed_proto_depIdxs = []int32{
	1, // 0: feed.FeedResponse.feedData:type_name -> feed.Post
	0, // 1: feed.FeedService.GetFeed:input_type -> feed.FeedRequest
	2, // 2: feed.FeedService.GetFeed:output_type -> feed.FeedResponse
